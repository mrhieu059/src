...
/*------------------------CustomeKey--------------------------*/
//	{0,XF86XK_AudioMute,	 	spawn, SHCMD("$HOME/.local/dot/myscript/volume.sh mute ; pkill -RTMIN+12 dwmblocks")},
//	{0,XF86XK_AudioLowerVolume,	spawn, SHCMD("$HOME/.local/dot/myscript/volume.sh - ; pkill -RTMIN+12 dwmblocks")},
